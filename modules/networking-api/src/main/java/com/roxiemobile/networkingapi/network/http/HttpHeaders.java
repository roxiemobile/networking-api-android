    ...
    public List<MediaType> getAccept() {
        ...
        if (result.size() == 1) {
            ...
            if (acceptHeader.size() > 1) {
                value = CompatStringUtils.collectionToCommaDelimitedString(acceptHeader);
...
//        set(ALLOW, CompatStringUtils.collectionToCommaDelimitedString(allowedMethods));
//    }
...
//    }
    ...
    public HttpHeaders andAdd(String headerName, String headerValue) {
    ...
    public HttpHeaders andSet(String headerName, String headerValue) {
