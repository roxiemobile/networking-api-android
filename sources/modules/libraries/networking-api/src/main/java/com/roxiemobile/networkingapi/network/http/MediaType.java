...
import com.roxiemobile.networkingapi.network.http.util.comparator.CompoundComparator;
...
public final class MediaType implements Comparable<MediaType> {
    ...
    /**
     * Return the character set, as indicated by a {@code charset} parameter, if any.
     * @return the character set; or {@code defaultValue} if this media type doesn't specify a charset.
     */
